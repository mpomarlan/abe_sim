...
def toChopStart(requestData, w, agentName, todos):
    return requests.status_codes.codes.NOT_IMPLEMENTED, {}

def toChopEnd(requestData, w, agentName):
...
commandFns = {
    ...
    "to-chop": [processActionRequest, toChopStart, toChopEnd]}
