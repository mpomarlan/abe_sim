...
class CounterTop(pob.PObject):
    def _customInitPreLoad(self, *args, **kwargs):
        ...
        self._customStateVariables = {"":  {"type": "countertop"}, "fn": {"boards": [[[-1.884,-0.568,0.747],[1.884,0.568,0.75]],[[-1.884,-0.464,0],[1.884,0.464,0.7]]], "supportbbs": [[[-1.7,-0.5,0.747],[1.7,0.5,0.75]]], "cancontain": True}}
