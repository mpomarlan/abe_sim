...
class KitchenCabinet(pob.PObject):
    def _customInitPreLoad(self, *args, **kwargs):
        ...
        self._customStateVariables = {"": {"type": "kitchencabinet"}, "fn": {"exitdirection": (0,1,0), "supportbbs": [[(-2.794,-0.126,0.165), (3.224,0.594,0.175)], [(-2.794,-0.126,-0.558), (3.224,0.594,-0.548)]]}}
