...
aliases = {"coffee": "dCoffee", "cup of coffee": "dCoffee", 
           "cafe au lait": "dCafeAuLait", "coffee with milk": "dCafeAuLait", "cappuccino": "dCafeAuLait", "latte": "dCafeAuLait", "cup of coffee with milk": "dCafeAuLait", 
...
reification2Alias = {"dCafeAuLait": "coffee with milk", "dTea": "tea"}

reification2ObjectName = {"coffee": "coffee",
                          "dCoffee": "coffee",
                          "dCafeAuLait": "coffeeCupWithMilk",
                          "dBlackCoffee": "coffeeCup",
                          "dTea": "teaCup",
        ...
        if 0 < len(specs):
            ...
            if feasible.get(pref, True):
                ...
                if pref is None:
                    ...
                    requestPerformAction("Transporting", {k[len("dialog/"):]:v for k, v in gS.items() if k.startswith("dialog/")}, context = "We don't have %s anymore, but we have %s instead." % (bl[0], pref))
                    iS["fn_sidx"] = fn_sidx_start
                    iS["entities"] = {}
                    return False
