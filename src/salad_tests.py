...
commands = [
        ...
        ["http://localhost:54321/abe-sim-command/to-cut", {'object': 'fetaCheese', 'cuttingTool': 'cookingKnife', 'cutPattern': 'dice', 'kitchenStateIn': None, 'setWorldState': False}, "./sWS3.log", "./sWS4.log"],
        ["http://localhost:54321/abe-sim-command/to-cut", {'object': 'broccoli', 'cuttingTool': 'cookingKnife', 'cutPattern': 'dice', 'kitchenStateIn': None, 'setWorldState': False}, "./sWS4.log", "./sWS5.log"],
        ["http://localhost:54321/abe-sim-command/to-cut", {'object': 'redOnion', 'cuttingTool': 'cookingKnife', 'cutPattern': 'dice', 'kitchenStateIn': None, 'setWorldState': False}, "./sWS5.log", "./sWS6.log"]
    ]
...
dgr = {'kitchenStateIn': json.loads(open('sWS6.log').read())}
...
toPlace = [x for x in worldState.keys() if (worldState[x]['type'] in ['ChoppedBroccoli', 'ChoppedRedOnion', 'FetaCheeseCube']) and ('kitchenCounter' == worldState[x]['at'])]
